    ...
    <header className="text-white px-6 py-4 absolute top-0 w-full z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4 mr-4">
          <button 
            className="bg-white text-black hover:bg-gray-100 px-6 py-3 transition-colors duration-200 flex items-center space-x-2 font-medium border-0 cursor-pointer"
            style={{ 
